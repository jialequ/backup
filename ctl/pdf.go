...
func generatePDF() {
	...
	// PDF 第一章
	tmp, err = loadChapter(chapterOneFileOrder, literal_5479, "ChapterOne")
	pdf = append(pdf, tmp...)
	// PDF 第二章
	tmp, err = loadChapter(chapterTwoFileOrder, literal_5479, "ChapterTwo")
	pdf = append(pdf, tmp...)
	// PDF 第三章
	tmp, err = loadChapter(chapterThreeFileOrder, literal_5479, "ChapterThree")
	pdf = append(pdf, tmp...)
	// PDF 第四章
